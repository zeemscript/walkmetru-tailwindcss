  ...
  return (
    <>
      <section className="grid grid-cols-1 md:grid-cols-2 md:gap-8 bg-[#F7FFFF] py-10 mt-8">
        ...
        <div className="flex flex-col justify-center items-center text-center md:text-left md:px-6">
          <span className="font-medium text-3xl md:text-5xl text-black leading-tight">
            Anyone can share
            <br />
            their skills and
            <br />
          ...
          <span className="text-black font-light text-base md:text-lg mt-4 md:mt-2">
